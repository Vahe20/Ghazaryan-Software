import { z } from "zod";
import { platformSchema } from "../apps/app.schema";

// Create download schema
export const createDownloadSchema = z.object({
	...
	userAgent: z.string().max(500, "User agent must be at most 500 characters").optional(),
...
// Download stats query schema
export const getDownloadStatsSchema = z.object({
	appId: z.string().uuid("Invalid app ID").optional(),
	groupBy: z.enum(["day", "week", "month", "platform", "country"]).default("day"),
	startDate: z.coerce.date().optional(),
	endDate: z.coerce.date().optional(),
});
