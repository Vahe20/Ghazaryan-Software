        ...
        <div className={style.statsGrid}>
            <div className={style.statCard}>
                ...
                <div className={style.statInfo}>
                    ...
                    <p className={style.statValue} title={rawBalance}>{formattedBalance}</p>
                </div>
                <button className={style.topUpBtn} onClick={onTopUpClick} title="Top up balance">
            ...
            <div className={style.statCard}>
                ...
                <div className={style.statInfo}>
                    ...
                    <p className={style.statValue}>{purchasesCount}</p>
                </div>
            </div>
