...
import { useTopUpBalanceMutation } from "@/src/features/api/paymentApi";
...
const TopUpModal = memo(function TopUpModal({ user, isOpen, onClose }: TopUpModalProps) {
    ...
    const handleTopUp = useCallback(async () => {
        ...
        try {
            const result = await topUpBalance(parsedAmount).unwrap();
    ...
    }, [dispatch, isAmountValid, onClose, parsedAmount, topUpBalance, user]);
